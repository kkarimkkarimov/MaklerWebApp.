...
public interface IMaklerApiClient
{
    ...
    Task<IReadOnlyList<ApiMapListingMarker>> SearchMapListingsAsync(ApiListingSearchRequest request, CancellationToken cancellationToken = default);
    Task<IReadOnlyList<ApiAzerbaijanLocation>> GetAzerbaijanLocationsAsync(CancellationToken cancellationToken = default);
    ...
    Task<ApiRegisterResponse?> RegisterAsync(ApiRegisterRequest request, CancellationToken cancellationToken = default);
    ...
    Task<ApiTokenResponse?> VerifyOtpAsync(ApiVerifyOtpRequest request, CancellationToken cancellationToken = default);
